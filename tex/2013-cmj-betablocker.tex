...
Another way to generate aesthetically interesting patterns with complex rhythmical interrelations can be achieved by letting botj engines run on the same heap.
...
Livecoding with Betablocker can be undertaken in various forms and on different levels; ranging from assembler-level programming over recursive livecoding based on the engine's capability of self-modification up to genetical algorithms and structural programming.
...
Over the course of the project, our preconception that the beast of computation with all its complexity is not to be tamed with our approach. 
