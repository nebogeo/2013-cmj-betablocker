...
In Betablocker, we differentiate between a core instruction set consisting of 22 distinct instructions and various add-ons that, depending on the actual application in which Betablocker is used, introduce side-effect features like playing a note (\texttt{NOTE}) or copying information to the output pins of an AVR chip (\texttt{OUT}).
