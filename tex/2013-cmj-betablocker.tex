...
Livecoding is attempting to treat computation as a material on it's own terms, pick it up, feel what shapes it has and make music with it. 
Betablocker is an approach to livecoding which has brought to light many different strategies for presenting computation as a tangible material -- and it does this by making the process as much part of a livecoding performance as the code that describes it.
...
% + betablocker as research in computing processes (till, dave)
%   + practice-based research through life coding
%   + making assembler code accessible (visual human speed programming)
%   + limitations and characters of betablocker assembler programs
