...
% TODO add e.g. nick collins instruction synthesis (breakpoint set interpreter) as a reference. also, fredrik did something in that respect. gotta ask him...
...
% TODO reviewer comment: use images to describe [...] the 'new ideas for artistic use'.
% TODO reviewer comment: "stuck in a creative rut" -- It would be insightful if the writer could explain some of these matters of mind and the extension of the senses through technologies of cognition and perception that he term 'Betablocker' implies.


% TODO editors comment: as a suggestion, reference one of the cognitive dimensions of notation here, which might provide further dimensions along which success (or otherwise) could be measured/considered.
...
% TODO optional: should we add the listings of Additive/FM/AM, or maybe one of them as an example?
...
% TODO reviewer comment: If you need to cut, the section discussing the various performances could probably be made more concise, and/or focus on the most interesting cases.
...
\label{sub:piksel}
% TODO reviewer comment: As a reader I would like to have an indication of what and how the 'performer' performed, f the gamepad was the only input was there gestures moving to the a/v what was the 'dramaturgical relationship of the live code and this relationship to the interface'? if indeed it was a performance was the 'audience' affect considered or what was the 'response' or atmosphere created by the live performance event.

% TODO editor comment: tell more about the first performance.
